...
const SERVICES: Svc[] = [
  ...
  { group: 'Studio hardware & tools', name: 'igloohome (iglooaccess API)', role: 'Front-door smart lock — generates the per-booking door codes in confirmation texts/emails. Second lock pending install.', url: 'https://access.igloocompany.co', cost: '$2/lock/month (trial until Aug 1, 2026)', creds: 'Bitwarden: igloohome API – Made Kulture' },
