          ...
          <div style={{ paddingBottom: 80 }}>
            ...
            <div style={{ display: 'flex', flexDirection: isMobile ? 'column' : 'row', alignItems: isMobile ? 'stretch' : 'flex-start', justifyContent: 'space-between', gap: isMobile ? 12 : 0, marginBottom: isMobile ? 20 : 28 }}>
              ...
              <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
                ...
                <a href="/admin/promos" style={{ display: 'inline-flex', alignItems: 'center', background: 'rgba(212,168,67,0.15)', border: '1px solid rgba(212,168,67,0.4)', color: '#e6c07a', textDecoration: 'none', padding: '9px 14px', fontFamily: '"JetBrains Mono", ui-monospace, monospace', fontSize: 11, fontWeight: 600, letterSpacing: '0.08em' }}>PROMO CODES →</a>
                <a href="/admin/marketing" style={{ display: 'inline-flex', alignItems: 'center', background: 'rgba(212,168,67,0.15)', border: '1px solid rgba(212,168,67,0.4)', color: '#e6c07a', textDecoration: 'none', padding: '9px 14px', fontFamily: '"JetBrains Mono", ui-monospace, monospace', fontSize: 11, fontWeight: 600, letterSpacing: '0.08em' }}>MARKETING →</a>
                <button
                  onClick={async () => {
                    setDupLoading(true)
