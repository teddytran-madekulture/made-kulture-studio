...
const STUDIO_RULES_FIELDS: ContentField[] = [
  ...
  { key: 'faq4Items', label: 'Questions',     type: 'list', group: 'Section 4 \u00b7 Studio rules',  item: FAQ_ITEM, default: JSON.stringify([
    ...
    { q: 'What is the messy concept and cleaning fee policy?', a: 'Messy concepts \u2014 paint, fake blood, glitter, excessive oils, waxes, smoke bombs and similar materials \u2014 are not allowed in the studio. If your shoot genuinely needs something messy, or anything outside how the studio normally runs, ask us before you book and we will tell you whether a concept review is possible. Reviews are decided case by case, approval is never guaranteed, and an approved concept carries a refundable cleaning deposit. A minimum $150 cleaning charge applies if the space is not left clean.' },
