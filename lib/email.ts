      ...
      <tr>
        <td>
          ...
          <ul style="margin:0;padding:0 0 0 16px;color:#bbb;font-size:13px;line-height:1.8;">
            <li style="margin-bottom:6px;"><strong style="color:#ddd;">Please do not arrive early.</strong> There is no studio access before your booked time — including the Studio Lounge — so you will not be able to wait or get ready inside. Parking is limited, and early arrivals take spaces from sessions already in progress. A few minutes ahead is perfect; setup and breakdown happen within your booked time.</li>
